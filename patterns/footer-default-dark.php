 ...
 * Slug: acost-wp/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'acost' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'acost' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'acost' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'acost' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'acost' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
